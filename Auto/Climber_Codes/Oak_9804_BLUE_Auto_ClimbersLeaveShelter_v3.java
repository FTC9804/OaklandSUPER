 ...
 *
 * v1 3-21-16 at 5:53 pm Steve -- initial test code for climber code with leaving the shelter to make room for partner
...
public class Oak_9804_BLUE_Auto_ClimbersLeaveShelter_v3 extends LinearOpMode {
...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive()) { //the op mode is active conditional forces the code to stop once the driver station specifies
            ...
            driveStraightForwards(-45, 12, 0.6);//heading, distance, mid power
            ...
            driveStraightBackwards(45, 24, 0.6);//heading, distance, mid power
