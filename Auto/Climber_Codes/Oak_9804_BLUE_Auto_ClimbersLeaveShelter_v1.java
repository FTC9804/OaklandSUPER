...
public class Oak_9804_BLUE_Auto_ClimbersLeaveShelter_v1 extends LinearOpMode {
...
//        allClear.setPosition(allClearPosition);
    ...
    void scoreShelterDrop(double shelterScoreTime) {
        ...
        this.resetStartTime();
        //do while loop to run servo while to loop is active
        do {
