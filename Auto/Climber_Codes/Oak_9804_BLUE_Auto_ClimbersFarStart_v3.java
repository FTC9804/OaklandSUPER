...
public class Oak_9804_BLUE_Auto_ClimbersFarStart_v3 extends LinearOpMode {
...
//        allClear.setPosition(allClearPosition);
        ...
        while (this.opModeIsActive()) { //move servo for 2 seconds to score, and 2 seconds to retract
