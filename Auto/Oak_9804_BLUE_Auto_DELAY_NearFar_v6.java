...
public class Oak_9804_BLUE_Auto_DELAY_NearFar_v6 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveStraightBackwards(0, 50.117, 0.5); //the distance is absolute, the heading is incremental, the mid power is absolute
    ...
    void driveStraightForwards (int heading, double distance, double midPower){      //first one is 90,24
        ...
        targetDistance = distance;      //distance given by the programmer
