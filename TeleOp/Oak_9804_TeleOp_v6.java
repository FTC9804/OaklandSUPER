 ...
 *v6 March 22, 2016 @ 2:47 Etienne L.
 */
    ...
    public void loop() {
        ...
        */
         ...
         */
            ...
            if (leadingPowerLeft > 0.094) {                         //left treads driving forward
                driveLeftBack.setPower(trailingPowerLeft);
                driveLeftFront.setPower(leadingPowerLeft);
            } else if (leadingPowerLeft < -0.094) {                 //left tread moving backward
        ...
        if ((((Math.abs(joystick2ValueRight)) >= 0.1)) && (((Math.abs(joystick2ValueRight)) <= 0.7))) {
            ...
            if ((joystick2ValueRight>0) && armsNotExtended) {
                ...
                arms.setPower(0.0);                 //Dont need this here, can remove later. Read again to make sure
            }
